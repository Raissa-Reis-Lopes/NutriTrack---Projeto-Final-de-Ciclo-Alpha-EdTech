function generateBarChart(title, totalValue, consumedValue, chartId, color, backgroundColor) {
...
function updateBarChart(chart, title, totalValue, consumedValue, color, backgroundColor) {
